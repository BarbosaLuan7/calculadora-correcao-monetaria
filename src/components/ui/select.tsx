...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        "flex w-full items-center justify-between gap-2 rounded-xl px-4 py-2 text-sm transition-all duration-300 outline-none",
    ...
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          ...
          "bg-white border border-gray-200 text-[#2f3a44]",
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        ...
        "text-[#424e5b] hover:text-[#2f3a44] hover:bg-gray-50",
        "focus:bg-[rgba(147,120,74,0.1)] focus:text-[#93784a]",
    ...
    >
      <span className="absolute right-2 flex size-3.5 items-center justify-center">
        <SelectPrimitive.ItemIndicator>
          <CheckIcon className="size-4 text-[#93784a]" />
        </SelectPrimitive.ItemIndicator>
      </span>
